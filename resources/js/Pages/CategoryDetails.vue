<!-- resources/js/pages/CategoryDetails.vue -->
<template>
    <Head :title="`${category.name} Books`" />
    
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ category.name }} Books</h2>
        </template>
        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <!-- Category Books -->
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Books in {{ category.name }}</h2>
                    ...
                    <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        ...
                        >
                            ...
                            <!-- Book Content Section - Flex-grow to push button to bottom -->
                            <div class="p-4 flex-grow flex flex-col">
                                ...
                                <div class="space-y-1 text-sm text-gray-600 mb-4">
                                    ...
                                    <p class="truncate"><span class="font-medium">Publisher:</span> {{ book.publisher || 'N/A' }}</p>
                                </div>
                                
                                <!-- Price and Stock Info - Fixed height section -->
                                <div class="mt-auto">
...
// Computed properties for category stats
